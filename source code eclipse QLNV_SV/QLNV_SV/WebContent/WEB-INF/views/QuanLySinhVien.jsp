          ...
          <h6 class="h2 text-white d-inline-block mb-0">Welcome</h6>
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item"><a href="QLSV.htm">Quản Lý Sinh Viên</a></li>
        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            ...
            <div class="col-lg-6 col-7">
              <form action="timkiem.htm" method="post" class="navbar-search navbar-search-light form-inline mr-sm-3" id="navbar-search-main" autocomplete="off">
            <div class="form-group mb-0">
              <div class="input-group input-group-alternative input-group-merge">
                <div class="input-group-prepend">
                  <span class="input-group-text"><i class="fas fa-search"></i></span>
                </div>
                <input autocomplete="off" class="form-control" title="nhập ALL để hiển thị tất cả sinh viên" placeholder="Nhập mã sinh viên hoặc mã lớp" type="text" name="ma">
              </div>
            </div>
            ...
            <div class="col-lg-6 col-7 text-right">
              ...
              <a href="goformsv.htm?cn=them" class="btn btn-sm btn-neutral">New +</a>
        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header border-0">
              <h3 class="mb-0">Table SINHVIEN: <c:out value="${result}"/> </h3>
            ...
            <div class="table-responsive">
              <table class="table align-items-center table-flush">
                <thead class="thead-light">
                  <tr>
                    <th scope="col" class="sort" data-sort="name">Mã Sinh Viên</th>
                    <th scope="col" class="sort" data-sort="budget">Họ Tên</th>
                    <th scope="col" class="sort" data-sort="status">Ngày Sinh</th>
                    <th scope="col">Địa Chỉ</th>
                    <th scope="col" class="sort" data-sort="completion">Mã Lớp</th>
                    <th scope="col" class="sort" data-sort="completion">Tên Đăng Nhập</th>
                    <th scope="col"></th>
                  </tr>
                </thead>
                <tbody class="list">
	                  ...
	                  <tr>
	                    <th scope="row">
	                      <div class="media align-items-center">
	                        <div class="media-body">
	                          <span class="name mb-0 text-sm"> <c:out value="${x.masv}"/> </span>
	                        </div>
	                      </div>
	                    </th>
	                    ...
	                    <td>
	                      <div class="d-flex align-items-center">
	                        <span class="completion mr-2"> <c:out value="${x.ngaysinh}"/> </span>
	                        
	                      </div>
	                    </td>
	                    
	                    <td class="budget">
	                        <c:out value="${x.diachi}"/>
	                    </td>
