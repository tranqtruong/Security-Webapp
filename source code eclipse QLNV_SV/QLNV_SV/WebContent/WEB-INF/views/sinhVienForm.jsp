      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="QLSV.htm">
            ...
            <div class="col-lg-6 col-7">
              ...
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  <li class="breadcrumb-item"><a href="QLSV.htm"><i class="fas fa-home"></i></a></li>
                  <li class="breadcrumb-item"><a href="QLSV.htm">Quản Lý Sinh Viên / Form</a></li>
          ...
          <div class="card">
            <div class="card-header">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0">Edit Sinh Vien: <c:out value="${message1}"/> </h3>
                </div>
            ...
            <div class="card-body">
              <form:form action="themSuaSinhVien${kt}${MASV}.htm" method="post" modelAttribute="sinhvien">
                ...
                <div class="pl-lg-4">
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <form:input autocomplete="off" type="text" id="input-username" class="form-control" placeholder="MASV" required="required" pattern="SV[0-9]{3}" title="SV??? example SV001, SV002" value="${sinhvien2.masv}" path="masv"/>
                      </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                      ...
                      <div class="form-group">
                        <label class="form-control-label" for="input-first-name">Mã lớp</label>
                        
                        <form:select class="form-control" required="required" path="malop" autocomplete="off">
  							<c:forEach var="x1" items="${ids}"> 
  								<option <c:if test="${sinhvien2.malop == x1}">selected</c:if> value="${x1}">${x1}</option>
                  ...
                  <div class="row">
                      ...
                      <div class="form-group">
                        ...
                        <form:input autocomplete="off" type="text" id="input-username" class="form-control" placeholder="HOTEN" pattern="[A-za-z\s]{1,99}" maxlength="99" title=" no special characters, numbers" required="required" value="${sinhvien2.hoten}" path="hoten"/>
                      </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
					        ...
					        <form:input class="form-control" type="date" placeholder="year/month/day" required="required" value="${sinhvien2.ngaysinh}" id="example-date-input" path="ngaysinh"/>
					    </div>
                    </div>
                  ...
                  <div class="row">
                      ...
                      <div class="form-group">
                        ...
                        <form:input autocomplete="off" type="text" id="input-username" class="form-control" placeholder="DIACHI" required="required" pattern="[-,A-za-z0-9\s]{1,199}" maxlength="199" value="${sinhvien2.diachi}" path="diachi"/>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <form:input autocomplete="off" type="text" id="input-first-name" class="form-control" placeholder="TENDN" required="required" pattern="[A-za-z0-9]{1,99}" maxlength="99" title="no special characters" value="${sinhvien2.tendn}" path="tendn" />
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-last-name">Mật khẩu</label>
                        <form:input autocomplete="off" type="text" id="input-last-name" class="form-control" placeholder="MATKHAU" required="required" pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{8,}$" title="Minimum eight characters, at least one uppercase letter, one lowercase letter, one number and one special character" value="${sinhvien2.matkhau}" path="matkhau" />
                      </div>
                    </div>
                  </div>
